...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; margin: 20px 0;">
  ...
  <!-- Contribution Streak div spanning both columns -->
  <div style="grid-column: span 2; margin: 10px; border-radius: 10px; background-color: #2d2d2d; padding: 20px; color: #fff; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2);">
